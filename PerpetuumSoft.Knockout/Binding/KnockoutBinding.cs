...
namespace PerpetuumSoft.Knockout
{
    public class KnockoutBinding<TModel> : KnockoutSubContext<TModel>, IHtmlString
    {
        ...
        // *** Events ***
        protected virtual KnockoutBinding<TModel> Event(string eventName, string actionName, string controllerName, object routeValues, bool redirect = false)
        {
            var sb = new StringBuilder();
            sb.Append("function() {");
            sb.Append(Context.ServerAction(actionName, controllerName, routeValues, redirect));
            sb.Append(";}");
            Items.Add(new KnockoutBindingStringItem(eventName, sb.ToString(), false));
            return this;
        }

        public KnockoutBinding<TModel> Click(string actionName, string controllerName, object routeValues = null, bool redirect = false)
        {
            return Event("click", actionName, controllerName, routeValues, redirect);
        }
